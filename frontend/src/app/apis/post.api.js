...
export const POSTAPI = {
    ...
    saveMealPost: (data) => axios.post(`${BASE_URL}/api/meal`, data),
    saveWorkoutPost: (data) => axios.post(`${BASE_URL}/api/workout`, data),
    saveWorkoutPlanPost: (data) => axios.post(`${BASE_URL}/api/workoutplan`, data),
