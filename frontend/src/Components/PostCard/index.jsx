        ...
        <div className="row" style={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          {post.trainer && (
            ...
            <div className="d-flex flex-row justify-content-between align-items-center">
              ...
              <div className="d-flex flex-row justify-content-between align-items-center">
                <h3>Trainer</h3>
                <h3> Mr.{post.trainer}</h3>
              </div>
              <div className="d-flex flex-row justify-content-between align-items-center">
                <h3>Counts</h3>
                <h3>Title: {post.counts}</h3>
              </div>
              <div className="d-flex flex-row justify-content-between align-items-center">
                <h3>Distance</h3>
                <h3>{post.distance}Km</h3>
              </div>
              {!editable && <p>{post.caption}</p>}
              {editable && (
                <input
          ...
          {/* If none of the types are fulfilled */}
          {!post.mtitle && !post.wtitle && !post.trainer && (
            <div style={{ flex: '1', marginRight: '20px' }}>
              {!editable && <p>{post.caption}</p>}
              {editable && (
                <input
