...
public class PostService {
    ...
    public ResponseEntity<?> getPosts() {
        ...
        for (Post post : posts) {
            ...
            postDTO.setMtitle(post.getMtitle());
            postDTO.setNutrition(post.getNutrition());
            postDTO.setWtitle(post.getWtitle());
            postDTO.setSets(post.getSets());
            postDTO.setExercise(post.getExercise());
            postDTO.setTrainer(post.getTrainer());
            postDTO.setCounts(post.getCounts());
            postDTO.setDistance(post.getDistance());
